...
Audited against the manuscript and the local PDF library on 2026-08-10.
Every one of the 13 bibliography keys is cited, has a corresponding local
PDF, and supports the statement to which it is attached.  Bibliographic
metadata and DOI values were checked against the PDFs; all retained entries
have a DOI.  The 2025 k-Toeplitz paper and its 2026 corrigendum occupy pages
1--29 and 30--31, respectively, of one combined local PDF.
...
The manuscript bibliography uses `siamplain.bst`, prints the 13 verified DOI
links, and treats `33`, `205201`, and `079501` as electronic article numbers
(`eid`) rather than page numbers.
